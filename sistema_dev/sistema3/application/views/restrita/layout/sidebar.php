<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown">
                <?= ($this->router->fetch_class() == 'home' && $this->router->fatch_method() == 'index')? '<div class="active"></div>':''?>
                <a href="<?= base_url("restrita/home"); ?>" class="nav-link"><i data-feather="home"></i><span>Inicio</span></a>
            </li>
            <li class="dropdown">
            <?= ($this->router->fetch_class() == 'usuarios' && $this->router->fatch_method() == 'index')? '<div class="active"></div>':''?>
