...
class Settings extends MY_Controller
{
    ...
    public function getSettings($id)
    {
        ...
        foreach ($this->data['results'] as $settings) {
            ...
            if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vProduto')) {
                $v = '<a style="margin-right: 1%" href="' . site_url() . "settings/visualizar/".$this->data['titlo'] ."/" . $settings->{"id_estoque_".$this->data['titulo'] } . '" class="btn-nwe" title="Visualizar Setting"><i class="bx bx-show bx-xs"></i></a>  ';
            }
    ...
    public function editar($id)
    {
        ...
        $this->data['urlLogo'] = ($this->data['result']->$e != '' and $this->data['result']->$e != null) ? $this->data['result']->$e : base_url().'assets/img/sem_logo.png';
