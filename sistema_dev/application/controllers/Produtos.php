...
class Produtos extends MY_Controller
{
    ...
    public function adicionar()
    {
        ...
        $this->data['custom_error'] = '';
        $this->data['resultProdutos'] = $this->setdb_model->getTabelaLastRow('estoque_produtos', '*', '', '', 'id_estoque_produto, asc') + 1;
    ...
    private function do_upload($setting = null)
    {
        ...
        if (!$this->upload->do_upload()) {
            $error = ['error' => $this->upload->display_errors()];
             ...
             $this->session->set_flashdata('error', "Erro ao fazer upload do arquivo, verifique se a extensão do arquivo é permitida. $erro");
